...
phone: z.string().min(0).optional(),
  ...
  commission: z.string().default("5.00"),  
  gender: z.string().min(1, "Gender is required"), 
  division: z.string().min(1, "Division is required"), 
  salesOrg: z.string().min(1, "Sales Org is required"),
  kycDocNoPOI: z.string().optional(),
  kycDocNoPOA: z.string().optional(),
...
title: z.string().refine((val) => val && val.trim() !== "", {
  ...
  firstName: z.string().min(1,"Please Enter FirstNanme"),
  middleName: z.string().optional(),
  lastName: z.string().min(1,"Please Enter lastName"),
  gender: z.string().nonempty("Please select Gender"),
  dateOfBirth: z.string().min(1,"Please select DOB"),
  race: z.string().min(1,"Please select Race"),
  phone: z.string().optional(),
  altPhone: z.string().optional(),
  mobile: z.string().min(1,"Please enter Mobile Number"),  
  email: z.string().min(1,"Please enter Email").email("Please enter a valid email address"),
  altEmail: z.string().email("Please enter a valid email address").optional().or(z.literal("")),  fax: z.string().optional(),
  ...
  address1Inst: z.string().min(1,"Please Enter Address1"),
  address2Inst: z.string().min(1,"Please Enter Address2"),
  postalCodeInst: z.string().min(1,"Please Enter Postal Code"),
  ...
  billingAddress1: z.string().min(1,"Please Enter Billing Address1"),
  billingAddress2: z.string().min(1,"Please Enter Billing Address2"),
  billingPostalCode: z.string().min(1,"Please Enter Billing PostalCode"),
  ...
  //financial & tax  
  ctinNumber: z.string().min(1,"TIN Number is Required"),
  cvrnNumber: z.string().min(1,"VRN is Required"),
