...
export class AgentHardwarePaymentController {
  ...
  static async getPayments(req: Request, res: Response) {
    try {
      ...
      console.error('Get hardware payments error:', error);
      res.status(500).json({
        success: false,
  ...
  static async getPayment(req: Request, res: Response) {
    try {
      ...
      console.error('Get hardware payment error:', error);
      res.status(500).json({
        success: false,
  ...
  static async createPayment(req: Request, res: Response) {
    try {
      ...
      const totalAmount = validatedData.payAmount + validatedData.vatAmount;
      ...
      console.error('Create hardware payment error:', error);
  ...
  static async updatePayment(req: Request, res: Response) {
    try {
      ...
      console.error('Update hardware payment error:', error);
      res.status(500).json({
        success: false,
  ...
  static async deletePayment(req: Request, res: Response) {
    try {
      ...
      console.error('Delete hardware payment error:', error);
      res.status(500).json({
        success: false,
  ...
  static async approvePayment(req: Request, res: Response) {
    try {
      ...
      console.error('Approve hardware payment error:', error);
      res.status(500).json({
        success: false,
  ...
  static async getPaymentStats(req: Request, res: Response) {
    try {
      ...
      const stats = {
        ...
        totalVat: paymentsToAnalyze.reduce((sum, p) => sum + p.vatAmount, 0),
