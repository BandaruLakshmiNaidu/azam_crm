        ...
        <div className="flex-1 max-w-2xl mx-8 relative" ref={searchRef}>
          <div className="search-bar-container relative rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none z-10">
              <div className={`flex items-center space-x-1 px-2 py-1 rounded-md text-xs transition-all duration-200 ${
                isSearchFocused ? 'bg-azam-blue/10 text-azam-blue border border-azam-blue/20' : 'text-gray-400'
              }`}>
                          ...
                          .map((page, index) => {
                            ...
                            return (
                              <div
                                ...
                                className={`search-item flex items-center space-x-3 p-3 rounded-xl cursor-pointer group ${
                                  isCurrentPage 
